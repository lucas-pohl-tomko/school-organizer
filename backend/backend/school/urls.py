...
urlpatterns = [
    ...
    url(r'schedulestudentsprofessor/destroy/(?P<pk>\d+)/$', ScheduleStudentProfessorDestroy.as_view()),
    url(r'schedulestudentsprofessor/add/$', ScheduleStudentProfessorCreate.as_view()),
